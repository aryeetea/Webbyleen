  ...
  return (
    <>
      <section className="relative overflow-hidden px-5 pb-24 pt-36 sm:px-6 sm:pt-40">
        <div className="absolute inset-x-0 top-0 h-[620px] bg-[radial-gradient(circle_at_top_right,rgba(255,208,0,0.36),transparent_34%),radial-gradient(circle_at_left,rgba(240,23,106,0.20),transparent_30%),radial-gradient(circle_at_60%_100%,rgba(240,23,106,0.12),transparent_28%)]" />
