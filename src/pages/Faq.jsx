  ...
  return (
    <>
      <section className="relative overflow-hidden px-5 pb-20 pt-36 sm:px-6 sm:pt-40">
        <div className="absolute inset-x-0 top-0 h-[520px] bg-[radial-gradient(circle_at_right,rgba(209,173,132,0.24),transparent_34%),radial-gradient(circle_at_left,rgba(117,88,54,0.12),transparent_28%)]" />
      ...
      <section className="px-5 pb-24 sm:px-6">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.86fr_1.14fr]">
          <div className="space-y-6">
            <div className="rounded-[28px] border border-warmbrown/12 bg-cream p-6 shadow-[0_24px_56px_rgba(17,17,16,0.06)]">
            ...
            <div className="rounded-[28px] border border-warmbrown/12 bg-softwhite p-6 shadow-[0_24px_56px_rgba(17,17,16,0.06)]">
